/**
	...
	`CFFGLPluginInfo` that Gate.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Gate.bundle/Contents/MacOS/Gate | grep gate
*/

extern "C" const char* GateBuildStamp()
{
	return "gate " GATE_VERSION " built " __DATE__ " " __TIME__;
}
